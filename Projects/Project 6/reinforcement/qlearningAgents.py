...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        return sum(self.weights[eachFeature] * allFeatures[eachFeature] for eachFeature in allFeatures)
    ...
    def update(self, state, action, nextState, reward: float):
        ...
        for eachFeature in allFeatures:
            self.weights[eachFeature] += self.alpha * difference * allFeatures[eachFeature]
